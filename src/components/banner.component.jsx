...
const BannerComponent = () => {
    return (
        ...
        <div className="bg-center bg-cover bg-[url('/src/images/banner/bannerbackground2.jpg')] bg-opacity-95 h-40 w-full flex justify-center group border-2 border-main-black overflow-hidden md:rounded-b-3xl md:rounded-t-md lg:h-44 lg:w-[45rem] lg:mx-[30%] lg:mt-0 4xl:h-56">
