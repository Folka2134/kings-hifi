...
const BannerComponent = () => {
    return (
        <div className="h-40 w-full flex justify-center group bg-gradient-to-b from-main-yellow to-main-green bg-opacity-95 border-2 border-main-black overflow-hidden md:rounded-3xl z-0 lg:h-52 lg:w-[45rem] lg:ml-[30%] lg:mt-0">
