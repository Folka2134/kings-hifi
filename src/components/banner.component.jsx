...
const BannerComponent = () => {
    return (
        ...
        <div className="h-52 lg:w-2/4 flex justify-center group bg-gradient-to-b from-main-yellow to-main-green bg-opacity-95 mt-56 lg:mt-0 lg:rounded-r-3xl overflow-hidden transition duration-100">                
