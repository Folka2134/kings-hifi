...
const NavbarComponent = () => {
    return (
        <div className="w-80 justify-between sticky top-0 bg-main-black bg-opacity-95 shadow-md shadow-main-black rounded-b-xl z-10 md:h-16 md:w-full md:flex">
            <GiHamburgerMenu size={50} className='md:hidden absolute m-2 text-white ' />
            <nav className='md:flex md:w-full md:justify-between'>
