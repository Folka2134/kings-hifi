...
const SoundsystemComponent = () => {
    return (
        <div className="h-[80vh] grid align-middle">
            <div className="grid grid-cols-1 grid-rows-2 gap-20 row-1 justify-items-center content-center p-12 md:grid-rows-none lg:grid-cols-2 lg:gap-24 xl:p-40">
